  ...
  return {
    ...
    'medicines:update': (payload) => {
      ...
      const info = db.prepare(
        ...
        parsed.body.type ?? null,
        parsed.body.category ?? null,
        parsed.body.unitType ?? null,
        parsed.body.unit ?? null,
        parsed.body.tabletsPerPack ?? null,
        parsed.body.volumeMl ?? null,
        parsed.body.supplierId ?? null,
        parsed.body.supplierName ?? null,
        parsed.body.manufacturerId ?? null,
        parsed.body.manufacturerName ?? null,
